...
HorizonSideRobots.isborder(side)::Bool = isborder(ROBOT,side)
HorizonSideRobots.ismarker()::Bool = ismarker(ROBOT)
HorizonSideRobots.temperature()::Integer = temperature(ROBOT)
